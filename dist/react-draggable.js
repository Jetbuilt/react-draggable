	...
	var Draggable = function (_React$Component) {
	  ...
	  function Draggable() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Draggable)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      ...
	      newState.clientX = Math.round(newState.clientX / 15) * 15;
		  newState.clientY = Math.round(newState.clientY / 15) * 15;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createCSSTransform(_ref) {
	  ...
	  // Fix to force CSS transform to always include the webkit vendor prefix
	  // This is needed to allow wkhtmltopdf PDF generator to work properly.
	  // @HACK - added 5-14-16
	  out[ 'WebkitTransform' ] = out.transform;
	...
	var DraggableCore = function (_React$Component) {
	  ...
	  function DraggableCore() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(DraggableCore)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      ...
	      _this.setState({
	        ...
	        scrollX: _this.props.propDocument.body.scrollLeft,
	        scrollY: _this.props.propDocument.body.scrollTop
	      });
	
	      // Translate el on page scroll.
	      (0, _domFns.addEvent)(_this.props.propDocument, 'scroll', _this.handleScroll);
	      // Add events to the document directly so we catch when the user's mouse/touch moves outside of
	      // this element. We use different events depending on whether or not we have detected that this
	      // is a touch-capable device.
	      (0, _domFns.addEvent)(_this.props.propDocument, dragEventFor.move, _this.handleDrag);
	      (0, _domFns.addEvent)(_this.props.propDocument, dragEventFor.stop, _this.handleDragStop);
	      ...
	      (0, _domFns.removeEvent)(_this.props.propDocument, 'scroll', _this.handleScroll);
	      (0, _domFns.removeEvent)(_this.props.propDocument, dragEventFor.move, _this.handleDrag);
	      (0, _domFns.removeEvent)(_this.props.propDocument, dragEventFor.stop, _this.handleDragStop);
	    }, _this.handleScroll = function (e) {
	      var s = _this.state,
	          x = _this.props.propDocument.body.scrollLeft,
	          y = _this.props.propDocument.body.scrollTop;
	  ...
	  _createClass(DraggableCore, [{
	    ...
	    value: function componentWillUnmount() {
	      ...
	      (0, _domFns.removeEvent)(this.props.propDocument, eventsFor.mouse.move, this.handleDrag);
	      (0, _domFns.removeEvent)(this.props.propDocument, eventsFor.touch.move, this.handleDrag);
	      (0, _domFns.removeEvent)(this.props.propDocument, eventsFor.mouse.stop, this.handleDragStop);
	      (0, _domFns.removeEvent)(this.props.propDocument, eventsFor.touch.stop, this.handleDragStop);
	      (0, _domFns.removeEvent)(this.props.propDocument, 'scroll', this.handleScroll);
