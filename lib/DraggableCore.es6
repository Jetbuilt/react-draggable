...
export default class DraggableCore extends React.Component {
  ...
  componentWillUnmount() {
    ...
    removeEvent(this.props.propDocument, eventsFor.mouse.move, this.handleDrag);
    removeEvent(this.props.propDocument, eventsFor.touch.move, this.handleDrag);
    removeEvent(this.props.propDocument, eventsFor.mouse.stop, this.handleDragStop);
    removeEvent(this.props.propDocument, eventsFor.touch.stop, this.handleDragStop);
    removeEvent(this.props.propDocument, 'scroll', this.handleScroll);
  ...
  handleDragStart: EventHandler = (e) => {
    ...
    this.setState({
      ...
      scrollX: this.props.propDocument.body.scrollLeft,
      scrollY: this.props.propDocument.body.scrollTop
    });

    // Translate el on page scroll.
    addEvent(this.props.propDocument, 'scroll', this.handleScroll);
    // Add events to the document directly so we catch when the user's mouse/touch moves outside of
    // this element. We use different events depending on whether or not we have detected that this
    // is a touch-capable device.
    addEvent(this.props.propDocument, dragEventFor.move, this.handleDrag);
    addEvent(this.props.propDocument, dragEventFor.stop, this.handleDragStop);
  };
  ...
  handleDragStop: EventHandler = (e) => {
    ...
    removeEvent(this.props.propDocument, 'scroll', this.handleScroll);
    removeEvent(this.props.propDocument, dragEventFor.move, this.handleDrag);
    removeEvent(this.props.propDocument, dragEventFor.stop, this.handleDragStop);
  };
  ...
  handleScroll: EventHandler = (e) => {
    const s = this.state, x = this.props.propDocument.body.scrollLeft, y = this.props.propDocument.body.scrollTop;
